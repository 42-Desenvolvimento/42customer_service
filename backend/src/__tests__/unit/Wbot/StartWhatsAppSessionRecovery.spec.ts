...
describe("WhatsApp session recovery", () => {
  ...
  it("recovers sendSeen failures by removing the stale session before init", async () => {
    const whatsapp = {
      id: 10,
      tenantId: 20,
  ...
  it("removes any existing WhatsApp session before starting a new client", async () => {
    const whatsapp = {
      id: 11,
      tenantId: 21,
      type: "whatsapp",
